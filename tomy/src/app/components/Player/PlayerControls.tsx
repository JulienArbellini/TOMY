...
interface PlayerControlsProps {
  ...
  isMuted: boolean;
  scale: number;
  controlsToShow: string[]; // Liste des contrôles à afficher
}
...
const PlayerControls: React.FC<PlayerControlsProps> = ({
  ...
  return (
    <div>
      ...
      {/* Bouton Rewind */}
      {controlsToShow.includes('rewind') && (
        <ControlButton
      ...
      {/* Bouton Forward */}
      {controlsToShow.includes('forward') && (
        <ControlButton
      ...
      {/* Bouton Volume Down */}
      {controlsToShow.includes('volume') && (
        <ControlButton
