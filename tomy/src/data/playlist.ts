...
export const playlist: PlaylistItem[] = [ 
    {
      ...
      playerConfig: {
        ...
        tracks: [
          ...
          { src: "/Album/V3/Pop.wav", title: "Pop", type: "audio" },
           ...
           { src: "/Album/V3/Unelongueplageavecdesvagues.wav", title: "Une longue plage avec des vagues", type: "audio" },
           { type: "video", src: "swhQF5DWmMU", title: "Cerf-Volant" },
           { src: "/Album/V3/FlightFeelingAcoustic.wav", title: "Flight Feeling Accoustic", type: "audio" },
