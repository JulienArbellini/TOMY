...
const inputDir = path.join(__dirname, '../../public/vectors/ELEMENTS/COMPRESSEUR'); // Répertoire source des images
const outputDir = path.join(__dirname, '../../public/vectors/ELEMENTS/COMPRESSEUR'); // Répertoire cible
